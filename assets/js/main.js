...
const translations = {
  en: {
    ...
    "about.name": "Chao Wang (王超)",
    "about.body1.after": "at Nanjing University of Science and Technology. My research focuses on remote sensing object detection, knowledge distillation, SAR image understanding, and optical-SAR multimodal learning.",
    "about.body2.label": "SAR Object Detection:",
    "about.body2.text": "Detection methods and benchmarks for synthetic aperture radar imagery under complex scenes.",
    "about.body3.label": "Optical-SAR Fusion:",
    ...
    "about.body5.text": "Efficient adaptation of large visual models for remote sensing detection and segmentation.",
    "news.title": "News",
    ...
    "education.njust.lab": "the PCA Laboratory, Key Laboratory of Intelligent Perception and Systems for High-Dimensional Information of Ministry of Education",
    "education.ahu.school": "Anhui University",
    "education.ahu.degree": "M.S. Student",
    "education.ahu.lab": "Anhui Provincial Key Laboratory of Multimodal Cognitive Computation",
  ...
  zh: {
    ...
    "about.title": "个人简介",
    "about.body1.before": "我是",
    "about.name": "Chao Wang（王超）",
    "about.body1.after": "，来自南京理工大学。我的研究方向包括遥感目标检测、知识蒸馏、SAR 图像理解以及光学-SAR 多模态学习。",
    "about.body2.label": "SAR 目标检测：",
    "about.body2.text": "复杂场景下合成孔径雷达图像的检测方法与基准数据。",
    "about.body3.label": "光学-SAR 融合：",
    "about.body3.text": "面向地球观测的跨模态定位与多模态表征学习。",
    "about.body4.label": "知识蒸馏：",
    "about.body4.text": "通过定位感知和生成式蒸馏实现紧凑且准确的检测器。",
    "about.body5.label": "基础模型适配：",
    "about.body5.text": "高效适配大视觉模型用于遥感检测与分割。",
    "news.title": "最新动态",
    "pubs.title": "代表论文",
    ...
    "education.njust.lab": "PCA 实验室，教育部高维信息智能感知与系统重点实验室",
    "education.ahu.school": "安徽大学",
    "education.ahu.degree": "硕士研究生",
    "education.ahu.lab": "安徽省多模态认知计算重点实验室",
